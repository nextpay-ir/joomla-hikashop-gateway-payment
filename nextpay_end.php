...
?>
<div align="center" class="hikashop_nextpay_end" id="hikashop_nextpay_end">
	<span id="hikashop_nextpay_end_message" class="hikashop_nextpay_end_message">
	...
	<span id="hikashop_nextpay_end_spinner" class="hikashop_nextpay_end_spinner hikashop_checkout_end_spinner">
	</span>
	<br/>
